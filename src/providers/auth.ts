...
// for demo purpose using below credentials
...
export const authProvider: AuthBindings = {
  ...
  check: async () => {
    try {
        ...
        // this is to know the user is authenticated or not
...
//   get the user information
  getIdentity: async () => {
    ...
    try {
        ...
        // we are using me:any because the GraphQL api dosen't have a type for the me query yet
        // we will add some queries and mutation later and change this to user which will be generated by codegen
